...
let myTransactions = new Transactions();
myTransactions.addTransaction(74);
myTransactions.addTransaction(143);
myTransactions.addTransaction(100);
myTransactions.addTransaction(79);
myTransactions.addTransaction(500);
let arr = myTransactions.getAllTransactions();